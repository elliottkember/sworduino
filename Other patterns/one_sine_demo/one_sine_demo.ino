...
#define NUM_LEDS 490                                           // Number of LED's.
...
int8_t thisspeed = 80;                                         // You can change the speed, and use negative values.
uint8_t allfreq = 32;                                         // You can change the frequency, thus overall width of bars.
int thisphase = 0;                                            // Phase change value gets calculated.
uint8_t thiscutoff = 192;                                     // You can change the cutoff value to display this wave. Lower value = longer wave.
int thisdelay = 1;                                           // You can change the delay. Also you can change the allspeed variable above. 
