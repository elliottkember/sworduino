...
int8_t thisspeed = 1;                                         // You can change the speed, and use negative values.
...
//  LEDS.addLeds<LED_TYPE, LED_DT, LED_CK, COLOR_ORDER>(leds, NUM_LEDS);  // Use this for WS2801 or APA102
  ...
  set_max_power_in_volts_and_milliamps(5, 10000);               // FastLED Power management set at 5V, 500mA
...
void resetvar() {                                             // Reset the variable back to the beginning.
  ...
  thisspeed = 40;                                              // You can change the speed, and use negative values.
